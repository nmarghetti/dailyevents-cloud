...
for(var n in e){var s=new Date(parseInt(e[n].timestamp)),i=toTwoDigits(s.getHours())+":"+toTwoDigits(s.getMinutes())+" "+e[n].participant,a=$("<li/>",{"data-icon":"false",html:i+": "+linkify(e[n].comment)})
a.addClass("ui-li-static"),t.append(a)}t.listview("refresh")}function linkify(e){var t=/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi
